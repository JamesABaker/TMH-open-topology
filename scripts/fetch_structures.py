...
list_of_channel_keyword = ["Ion channel", "Ion transport", "Translocase", "Translocation", "Sugar transport", "Nuclear pore complex", "Amino-acid transport", "Ammonia transport", "Copper transport", "Electron transport",
...
pdb_ids = Structure.objects.filter(uniprot_protein_id__keywords__keyword__in=list_of_channel_keyword,
                                   uniprot_protein_id__total_tmh_number__gte=1).distinct('pk').values_list("pdb_id")
