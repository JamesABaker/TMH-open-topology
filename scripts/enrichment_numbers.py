...
def query_sets():
    ...
    insideflank_vars = Variant.objects.filter(
        ...
        residue__flank_residue__flank__inside_or_outside="I",
    ).distinct("pk")
    insideflank_res = Residue.objects.filter(
        flank_residue__flank__tmh__meta_tmh=True,
        flank_residue__flank__inside_or_outside="I",
    ).distinct("pk")
    print("Inside flanks")
    enrichment_print(
    ...
    outsideflank_vars = Variant.objects.filter(
        disease_status="d",
        residue__flank_residue__flank__tmh__meta_tmh=True,
        residue__flank_residue__flank__inside_or_outside="O",
    ).distinct("pk")
    outsideflank_res = Residue.objects.filter(
        flank_residue__flank__tmh__meta_tmh=True,
        flank_residue__flank__inside_or_outside="O",
    ).distinct("pk")
    ...
    deltagspont_var = Variant.objects.filter(
        ...
        residue__tmh_residue__tmh_id__tmh_deltag__test_score__lte="-0.5",
    ).distinct("pk")
    deltagspont_res = Residue.objects.filter(
        tmh_residue__tmh_id__meta_tmh=True,
        tmh_residue__tmh_id__tmh_deltag__test_score__lte="-0.5",
    ).distinct("pk")
    ...
    deltagnonspont_var = Variant.objects.filter(
        disease_status="d",
        residue__tmh_residue__tmh_id__meta_tmh=True,
        residue__tmh_residue__tmh_id__tmh_deltag__test_score__gte="0.5",
    ).distinct("pk")
    deltagnonspont_res = Residue.objects.filter(
        tmh_residue__tmh_id__meta_tmh=True,
        tmh_residue__tmh_id__tmh_deltag__test_score__gte="0.5",
    ).distinct("pk")
    ...
    tmsocsim_var = Variant.objects.filter(
        disease_status="d",
        residue__tmh_residue__tmh_id__meta_tmh=True,
        residue__tmh_residue__tmh_id__tmh_tmsoc__test_score__lte=-5,
    ).distinct("pk")
    tmsocsim_res = Residue.objects.filter(
        tmh_residue__tmh_id__meta_tmh=True,
        tmh_residue__tmh_id__tmh_tmsoc__test_score__lte=-5,
    ).distinct("pk")
    print("TMSOC simple")
    enrichment_print(
    ...
    tmsocfun_var = Variant.objects.filter(
        disease_status="d",
        residue__tmh_residue__tmh_id__meta_tmh=True,
        residue__tmh_residue__tmh_id__tmh_tmsoc__test_score__gte=-2.5,
    ).distinct("pk")
    tmsocfun_res = Residue.objects.filter(
        tmh_residue__tmh_id__meta_tmh=True,
        tmh_residue__tmh_id__tmh_tmsoc__test_score__gte=-2.5,
    ).distinct("pk")
    print("TMSOC complex")
    enrichment_print(
