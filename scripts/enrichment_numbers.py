...
def query_sets():
    ...
    ### Inside flanks ###
    insideflank_vars=Variant.objects.filter(disease_status='d', residue__flank_residue__flank__tmh__meta_tmh=True, residue__flank_residue__flank__inside_or_outside="Inside").distinct('pk')
    ...
    ### Outside flanks ###
    outsideflank_vars=Variant.objects.filter(disease_status='d', residue__flank_residue__flank__tmh__meta_tmh=True, residue__flank_residue__flank__inside_or_outside="Outside").distinct('pk')
    ...
    deltagspont_var=Variant.objects.filter(disease_status='d', residue__tmh_residue__tmh_id__meta_tmh=True, residue__tmh_residue__tmh_id__tmh_deltag__test_score__lte="-0.1").distinct('pk')
    ...
    deltagnonspont_var=Variant.objects.filter(disease_status='d', residue__tmh_residue__tmh_id__meta_tmh=True, residue__tmh_residue__tmh_id__tmh_deltag__test_score__gte="0.1").distinct('pk')
    ...
    ### TMSOC anchore ###
    tmsocsim_var=Variant.objects.filter(disease_status='d', residue__tmh_residue__tmh_id__meta_tmh=True,residue__tmh_residue__tmh_id__tmh_tmsoc__test_result="simple").distinct('pk')
    ...
    tmsocfun_var=Variant.objects.filter(disease_status='d', residue__tmh_residue__tmh_id__meta_tmh=True,residue__tmh_residue__tmh_id__tmh_tmsoc__test_result="complex").distinct('pk')
