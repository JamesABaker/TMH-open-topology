...
def plot_positions_disease_propensity(all_positions_disease, all_positions_gnomad, colour):
    count_coordinates=[]
...
#print(Variant.objects.filter(residue__protein__uniprot_id=aline).values_list("residue__sequence_position"))
    return(list(Variant.objects.filter(disease_status='n', residue__tmh_residue__evidence=evidence_source).distinct('pk').values_list("residue__tmh_residue__amino_acid_location_in_to_out", "aa_wt", "aa_mut")))

def get_variant_z_benign_flank():
#print(Variant.objects.filter(residue__protein__uniprot_id=aline).values_list("residue__sequence_position"))
    return(list(Variant.objects.filter(disease_status='n', residue__flank_residue__evidence=evidence_source).distinct('pk').values_list("residue__flank_residue__amino_acid_location_in_to_out", "aa_wt", "aa_mut")))
...
def add_to_disease_prop_plot(list_disease, list_benign, colour):
    ...
    plot_positions_disease_propensity(disease_clean_positions_list,benign_clean_positions_list, colour)
