...
print(len(helix_gnomad3_query), "gnomad v3 variants in the helix")
...
print(len(helix_gnomad2_query), "gnomad v2 variants in the helix")
...
# Pore residues
pore_disease_query=Variant.objects.filter(residue__tmh_residue__feature_location="TMH", residue__structural_residue__porewalker_score__gte=9, residue__tmh_residue__tmh_id__meta_tmh=True, disease_status='d', variant_source="ClinVar").values_list("aa_wt", "aa_mut", "residue__sequence_position", "residue__protein__uniprot_id")
...
pore_benign_query=Variant.objects.filter(residue__tmh_residue__feature_location="TMH", residue__structural_residue__porewalker_score__gte=9, residue__tmh_residue__tmh_id__meta_tmh=True, disease_status='n', variant_source="ClinVar").exclude(aa_mut=F("aa_wt")).values_list("aa_wt", "aa_mut", "residue__sequence_position", "residue__protein__uniprot_id")
...
pore_gnomad3_query=Variant.objects.filter(residue__tmh_residue__feature_location="TMH", residue__structural_residue__porewalker_score__gte=9, residue__tmh_residue__tmh_id__meta_tmh=True, variant_source="gnomAD3").exclude(aa_mut=F("aa_wt")).values_list("aa_wt", "aa_mut", "residue__sequence_position", "residue__protein__uniprot_id")
...
pore_gnomad2_query=Variant.objects.filter(residue__tmh_residue__feature_location="TMH", residue__structural_residue__porewalker_score__gte=9, residue__tmh_residue__tmh_id__meta_tmh=True, variant_source="gnomAD2").exclude(aa_mut=F("aa_wt")).values_list("aa_wt", "aa_mut", "residue__sequence_position", "residue__protein__uniprot_id")
