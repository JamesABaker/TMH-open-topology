...
for aline in file:
    ...
    all_id_vars = Variant.objects.filter(variant_source="ClinVar", disease_status='d', residue__protein__uniprot_id=aline).count()
    ...
    print(all_id_vars, tmh_id_vars, flank_id_vars, non_tmh_id_vars)
    all = all + all_id_vars
    tmh = tmh + tmh_id_vars
