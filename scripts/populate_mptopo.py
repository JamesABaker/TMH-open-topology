                    ...
                    for tm_find in features:
                        ...
                        if str(tm_find.tag) == str("tmSegments"):
                            ...
                            for tm_number, tmh_segment in enumerate(tmhs):
                                ...
                                n_ter_seq = mptopo_sequence[
                                    int(tmh_start) - 5 : int(tmh_start)
                                ]
                                tmh_sequence = mptopo_sequence[
                                    int(tmh_start) : int(tmh_stop)
                                ]
                                c_ter_seq = mptopo_sequence[
                                    int(tmh_stop) : int(tmh_stop) + 5
                                ]
